...
public class BankGrpcService extends BankServiceGrpc.BankServiceImplBase {
    ...
    public void convert(Bank.ConvertCurrencyRequest request, StreamObserver<Bank.ConvertCurrencyResponse> responseObserver) {
        ...
        Bank.ConvertCurrencyResponse response = Bank.ConvertCurrencyResponse.newBuilder()
                ...
                .setAmount(amount)
                .setResult(amount*Math.random()*10.2)
                .build();
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                Bank.ConvertCurrencyResponse response = Bank.ConvertCurrencyResponse.newBuilder()
                        ...
                        .setCurrencyTo(currencyTo)
                        .setAmount(amount)
                        .setResult(amount*Math.random()*10.3)
                        .build();
    ...
    @Override
    public StreamObserver<Bank.ConvertCurrencyRequest> fullCurencyStream(StreamObserver<Bank.ConvertCurrencyResponse> responseObserver) {
        return new StreamObserver<Bank.ConvertCurrencyRequest>() {
            @Override
            public void onNext(Bank.ConvertCurrencyRequest convertCurrencyRequest) {
                Bank.ConvertCurrencyResponse response = Bank.ConvertCurrencyResponse.newBuilder()
                        .setResult(convertCurrencyRequest.getAmount()*Math.random()*12.8)
                        .build();
